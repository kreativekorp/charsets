...
public class AtasciiDecoder extends CharsetDecoder {
	...
	private static final int[] INTL_LOW = {
		0x00E1,  0x00F9,  0x00D1,  0x00C9,  0x00E7,  0x00F4,  0x00F2,  0x00EC,  // áùÑÉçôòì
		0x00A3,  0x00EF,  0x00FC,  0x00E4,  0x00D6,  0x00FA,  0x00F3,  0x00F6,  // £ïüäÖúóö
		0x00DC,  0x00E2,  0x00FB,  0x00EE,  0x00E9,  0x00E8,  0x00F1,  0x00EA,  // Üâûîéèñê
		0x00E5,  0x00E0,  0x00C5,  0x241B,  0x2191,  0x2193,  0x2190,  0x2192,  // åàÅ␛↑↓←→
	};
	private static final int[] INTL_HIGH = {
		0x00A1,  0x0061,  0x0062,  0x0063,  0x0064,  0x0065,  0x0066,  0x0067,  // ¡abcdefg
		0x0068,  0x0069,  0x006A,  0x006B,  0x006C,  0x006D,  0x006E,  0x006F,  // hijklmno
		0x0070,  0x0071,  0x0072,  0x0073,  0x0074,  0x0075,  0x0076,  0x0077,  // pqrstuvw
		0x0078,  0x0079,  0x007A,  0x00C4,  0x007C,  0x1F8B0, 0x25C0,  0x25B6,  // xyzÄ|🢰◀▶
	};
